...
exports.BattlePokedex = {
	...
	mantiprey: {
		...
		pixinga: {
			...
			abilities: {0: "Cute Charm", 1:"Tangled Feet", H: "Unaware"},
			heightm: 0.6,
			weightkg: 1.3,
			color: "Pink",
			evos: "pixingillo",
		...
		flamingairy: {
			...
			abilities: {0: "Cute Charm", 1:"Tangled Feet", H: "Rain Dish"},
			heightm: 2.2,
			weightkg: 46.8,
			color: "Pink",
			prevo: "pixingillo",
		...
		amphireeze: {
			...
			species: "Amphireeze",
			types: ["Ice"],
			baseStats: {hp: 50, atk: 60, def: 65, spa: 75, spd: 75, spe: 70},
		...
		froxic: {
			...
			species: "Froxic",
			types: ["Ice", "Poison"],
			baseStats: {hp: 73, atk: 70, def: 70, spa: 105, spd: 90, spe: 101},
			abilities: {0: "Snow Warning", 1:"Refirgerate", H: "Adaptability"},
			heightm: 1.1,
			weightkg: 21.6,
			color: "Blue",
		...
		corupine: {
			...
			species: "Corupine",
			types: ["Normal", "Steel"],
			baseStats: {hp: 85, atk: 100, def: 107, spa: 50, spd: 57, spe: 51},
			abilities: {0: "Iron Barbs", 1:"Prey Stinging", H: "Bullet Proof"},
			heightm: 0.8,
			weightkg: 54.6,
			color: "Gray",
		...
		marikaiser: {
			...
			species: "Marikaiser",
			types: ["Bug", "Fire"],
			baseStats: {hp: 64, atk: 32, def: 58, spa: 91, spd: 58, spe: 110},
		...
		goliathorn: {
			...
			species: "Goliathorn",
			types: ["Grass", "Rock"],
			baseStats: {hp: 105, atk: 116, def: 100, spa: 86, spd: 60, spe: 60},
			abilities: {0: "Hyper Cutter", 1: "Immunity", H: "Tough Claws"},
			heightm: 2.4,
			weightkg: 139.2,
			color: "Brown",
		...
		hydraptor: {
			...
			species: "Hydraptor",
			types: ["Water", "Flying"],
			baseStats: {hp: 71, atk: 95, def: 74, spa: 95, spd: 82, spe: 109},
		...
		zaperal: {
			...
			species: "Zaperal",
			types: ["Rock", "Electric"],
			baseStats: {hp: 55, atk: 60, def: 80, spa: 125, spd: 90, spe: 100},
